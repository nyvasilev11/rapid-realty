    ...
    <section className='Pricing container'>
      ...
      <div className='Pricing-content'>
        <div className='Pricing-box white-box'>
          ...
          <p className='Pricing-box-price white-price'>
            Apartment A <span className='black'>$125,000</span>
          </p>
        ...
        <div className='Pricing-box green-box'>
          ...
          <p className='Pricing-box-price green-price'>
            Apartment B <span className='white'>$148,000</span>
          </p>
          <ul className='Pricing-info'>
            <li>
              340 m<sup>2</sup>
        ...
        <div className='Pricing-box white-box'>
          ...
          <p className='Pricing-box-price white-price'>
            Apartment C <span className='black'>$225,000</span>
          </p>
          <ul className='Pricing-info'>
            <li>
              480 m<sup>2</sup>
