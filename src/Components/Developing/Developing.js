        ...
        <div className='right-side'>
          <div className='box'>
            ...
            <p className='sub-title'>
              Building A <span>Completed</span>
            </p>
            <p className='text'>
              Fusce pretium dui quis est pretium lobortis. Vestibulum eu ex sed
              nibh condimentum tristique eu finibus lorem. Nullam sed eleifend
              massa.
            </p>
          </div>
          <div className='box'>
            ...
            <p className='sub-title'>
              Building B <span>Completed</span>
            </p>
            <p className='text'>
              Fusce pretium dui quis est pretium lobortis. Vestibulum eu ex sed
              nibh condimentum tristique eu finibus lorem. Nullam sed eleifend
          ...
          <div className='box'>
            ...
            <p className='sub-title'>
              Building C <span className='grey'>In Progress</span>
            </p>
            <p className='text'>
              Fusce pretium dui quis est pretium lobortis. Vestibulum eu ex sed
              nibh condimentum tristique eu finibus lorem. Nullam sed eleifend
